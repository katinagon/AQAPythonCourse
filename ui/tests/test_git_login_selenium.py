...
from pages.selenium.git_login import GitLoginPage
...
class TestGitLoginSelenium:
    ...
    def test_authorization_with_incorrect_login_password(self, driver, login, password):
        login_page = GitLoginPage(driver)
        login_page.open()
